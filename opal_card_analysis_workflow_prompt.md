Input Node (Data Ingestion): This workflow accepts transaction data. It can connect to Google Drive files, such as CSVs and Sheets, or integrate with real-time data sources.
